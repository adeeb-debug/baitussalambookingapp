...
console.log("LocationDetailsCollapse isAdmin:", isAdmin);
  ...
  return (
    <TableRow>
      <TableCell style={{ paddingBottom: 0, paddingTop: 0 }} colSpan={10}>
        <Collapse
          in={group.groupId === expandedGroup}
          timeout="auto"
          unmountOnExit
        >
          <Box sx={{ margin: 1 }}>
          ...
          <TableCell>
            <Box sx={{ display: "flex", gap: 0.5 }}>
              {subBooking.status === "Pending" && (
                <>
                  <Button
                    ...
                    size="small"
                    onClick={() =>
                      handleAction(subBooking.id, "Approved")
                    }
                    disabled={actionLoadingId === subBooking.id}
                  >
                    {actionLoadingId === subBooking.id ? (
                  ...
                  <Button
                    ...
                    size="small"
                    onClick={() =>
                      handleAction(subBooking.id, "Rejected")
                    }
                    disabled={actionLoadingId === subBooking.id}
                  >
                    {actionLoadingId === subBooking.id ? (
              ...
              <Button
                ...
                size="small"
                onClick={() =>
                  handleAction(subBooking.id, "Delete")
                }
                disabled={actionLoadingId === subBooking.id}
              >
